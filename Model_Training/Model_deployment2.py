...
#ANN_model = joblib.load('/home/firedetection/Documents/Central_system/Model_Training/pkl/ANN_main.pkl')
ANN_model = joblib.load('/home/firedetection/Documents/Central_system/Model_Training/pkl/Logistic_model.pkl')
LR_model = joblib.load('/home/firedetection/Documents/Central_system/Model_Training/pkl/Logistic_model.pkl')
RF_model = joblib.load('/home/firedetection/Documents/Central_system/Model_Training/pkl/Logistic_model.pkl')
    ...
    if -1 not in data_to_predict: #check if it has collect all data points messages
        ...
        for i in range(len(data_to_predict)):
            if i == 5 or i == 11 or i == 17 or i == 23:
                 continue
            data_to_predictNL.append(data_to_predict[i])

        print(data_to_predictNL)
        data_np = np.array(data_to_predictNL)
